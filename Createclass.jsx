            ...
            <Adminsidenav>
                <Row style={styles.userBody} className='rowHead'>
                        ...
                        {show && (<div style={adding}>
                            <div style={addOuter}>
                                ...
                                <div style={modalBorder}>
                                    ...
                                    <div style={modalBorder}>
                                        <Form.Control type="text" placeholder="Class" style={inputField} />
                                    </div>
                                    <div style={modalBorder}>
                    ...
                    <div style={styles.table}>
                        <div className='rows' style={{ ...styles.rows, marginRight: '50px' }}>
                            ...
                            <h6 style={{fontSize:'15px',marginBottom:'-2px',marginTop:'6px',fontStyle:'bold'}}>CLASS</h6>
                                <p style={{fontSize:'10px'}}>LKG</p>
                        ...
                        <div className='col' style={styles.column}>
                            ...
                            <div className='col' style={styles.col2}>
                            <h6 style={{fontSize:'15px',marginBottom:'-2px',marginTop:'6px',fontStyle:'bold'}}>LKG</h6>
