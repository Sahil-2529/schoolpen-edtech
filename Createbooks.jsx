            ...
            <Adminsidenav>
                <Row style={styles.userBody}>
                    <Row style={styles.link}>
                        <a href='#000' style={styles.createLink} onClick={handleShow}>Add Books</a>
                        ...
                        {show && (<div style={adding}>
                            <div style={addOuter}>
                                ...
                                <div style={modalBorder}>
                                    ...
                                    <div style={modalBorder}>
                                        <Form.Control type="text" placeholder="Book" style={inputField} />
                                    </div>
                                    <div style={modalBorder}>
                    ...
                    <div style={styles.table}>
                        <div className='rows' style={{ ...styles.rows, marginRight: '50px' }}>
                            ...
                            <h6 style={{fontSize:'15px',marginBottom:'-2px',marginTop:'6px',fontStyle:'bold'}}>Mathematics</h6>
                                <p style={{fontSize:'10px'}}>Stream</p>
